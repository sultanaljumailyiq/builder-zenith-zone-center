  ...
  return (
    ...
    >
      <div className="flex relative">
        {/* Desktop Sidebar */}
        <div className="hidden lg:block w-64 fixed top-16 right-0 bottom-0 bg-white border-l border-gray-200 z-30 shadow-xl">
          <div className="h-full overflow-y-auto">
            {/* Store Header with Animation */}
            <div className="p-6 border-b border-gray-200 bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-600 relative overflow-hidden">
              {/* Background Pattern */}
