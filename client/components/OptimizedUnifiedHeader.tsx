...
// Navigation sections - استبدال المقالات بالخدمات الطبية
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                ...
                {showUserMenu && (
                  <div
                    className="absolute right-0 lg:left-0 top-full mt-2 w-64 max-w-[calc(100vw-1rem)] bg-white rounded-xl shadow-lg border border-gray-200 z-50"
