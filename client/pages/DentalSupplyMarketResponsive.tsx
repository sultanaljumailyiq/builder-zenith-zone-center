    ...
    <div className="min-h-screen" dir="rtl">
      <main className="p-2 md:p-4 lg:p-8">
        ...
        <SmartProductsGrid
          ...
          products={enhancedProducts.slice(0, 10)}
        ...
        <SmartProductsGrid
          ...
          products={flashDealsProducts.slice(0, 10).map((product, index) => ({
            ...product,
        ...
        <SmartProductsGrid
          ...
          products={newArrivals.slice(0, 10).map((product, index) => ({
            ...product,
        ...
        <SmartProductsGrid
          ...
          products={mostDemanded.slice(0, 10).map((product, index) => ({
            ...product,
          ...
          <div className="unified-product-grid product-scroll-enhanced">
            {[
              ...
              <Link
                ...
                className="flex-shrink-0 bg-white p-3 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 group w-28 h-20"
              >
                <div className="text-center h-full flex flex-col justify-center">
                  <div className="w-8 h-8 mx-auto mb-1 bg-gray-50 rounded-lg overflow-hidden group-hover:scale-110 transition-transform duration-300 relative">
                    <img
                      src={supplier.image}
                      alt={supplier.name}
                  ...
                  <h3 className="font-bold text-gray-900 text-xs line-clamp-1 group-hover:text-teal-600 transition-colors">
                    {supplier.name}
                  </h3>
