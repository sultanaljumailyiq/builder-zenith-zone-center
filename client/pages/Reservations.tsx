    ...
    <div className="space-y-6" dir="rtl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {filteredAppointments.map((appointment) => (
          <div
            key={appointment.id}
            className="bg-white rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-500 group overflow-hidden"
          >
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-4">
                    <div
                      className={cn(
                        "w-14 h-14 rounded-2xl flex items-center justify-center font-bold text-base shadow-lg border-2 border-white/50 backdrop-blur-sm",
                        appointment.color,
                      )}
                    >
                      {appointment.avatar}
                    ...
                    <div>
                      <h3 className="font-bold text-lg text-gray-900 group-hover:text-indigo-600 transition-colors mb-1">
                        {appointment.patient}
                      </h3>
                ...
                <div className="flex items-center gap-3 mb-3">
                  <div className="flex items-center gap-2 bg-white/70 backdrop-blur-sm px-4 py-2 rounded-xl border border-white/50">
            ...
            <div className="p-6">
              <div className="space-y-4 mb-6">
                <div className="flex items-center gap-3 p-3 bg-gray-50/80 rounded-xl hover:bg-gray-100/80 transition-all">
                  ...
                  <div>
                    <p className="text-xs text-gray-500 font-medium">رقم الهاتف</p>
                ...
                <div className="flex items-center gap-3 p-3 bg-gray-50/80 rounded-xl hover:bg-gray-100/80 transition-all">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-800">{appointment.email}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => setIsCalendarOpen(true)}
                  className="flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg hover:shadow-xl font-medium"
                >
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all shadow-lg hover:shadow-xl font-medium"
                >
                  <Edit className="w-4 h-4" />
                  تعديل
                </button>
                <button className="p-3 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-xl hover:from-red-600 hover:to-pink-600 transition-all shadow-lg hover:shadow-xl">
            ...
            <div className="sticky top-0 bg-gradient-to-r from-green-600 to-emerald-600 p-6 rounded-t-3xl text-white z-10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-green-100">إضافة بيانات مريض جديد إلى النظام</p>
                </div>
                <button
            ...
            <div className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">التاريخ المرضي</label>
                    <textarea
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">جهة اتصال طوارئ</label>
                      <input
                        type="text"
            ...
            <div className="sticky top-0 bg-gradient-to-r from-purple-600 to-indigo-600 p-6 rounded-t-3xl text-white z-10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-purple-100">إدارة المواعيد والجدول الزمني للعيادة</p>
                </div>
                <button
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-2xl border border-blue-100">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-2">جدولة سريع��</h3>
                  <p className="text-gray-600 text-sm mb-4">إنشاء مواعيد جديدة بسرعة</p>
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-2xl border border-green-100">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-2">المواعيد المتكررة</h3>
                  <p className="text-gray-600 text-sm mb-4">جدولة مواعيد دورية</p>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-2xl border border-purple-100">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-2">إعدادات الجدول</h3>
                  <p className="text-gray-600 text-sm mb-4">تخصيص أوقات العمل</p>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div className="p-4 bg-blue-50 rounded-xl border border-blue-100">
                    <h4 className="font-semibold text-blue-900 mb-2">فحص عام</h4>
                    <p className="text-sm text-blue-700 mb-2">30 دقيقة</p>
                    <p className="text-xs text-blue-600">فحص روتيني شامل للأسنان</p>
                  </div>

                  <div className="p-4 bg-green-50 rounded-xl border border-green-100">
                    <h4 className="font-semibold text-green-900 mb-2">تنظيف الأسنان</h4>
                    <p className="text-sm text-green-700 mb-2">45 دقيقة</p>
                    <p className="text-xs text-green-600">تنظيف وتلميع الأسنان</p>
                  </div>

                  <div className="p-4 bg-purple-50 rounded-xl border border-purple-100">
                    <h4 className="font-semibold text-purple-900 mb-2">��راعة الأسنان</h4>
            ...
            <div className="sticky top-0 bg-gradient-to-r from-orange-600 to-red-600 p-6 rounded-t-3xl text-white z-10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-orange-100">تنظيم وإرسال التنبيهات للمرضى والطاقم الطبي</p>
                </div>
                <button
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-2xl border border-blue-200">
                  ...
                  <h3 className="font-semibold text-blue-900 mb-1">رسائل نصية</h3>
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-2xl border border-green-200">
                  ...
                  <h3 className="font-semibold text-green-900 mb-1">مكالمات هاتفية</h3>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-2xl border border-purple-200">
                  ...
                  <h3 className="font-semibold text-purple-900 mb-1">بريد إلكتروني</h3>
                  <p className="text-xs text-purple-700">تذكيرات م��صلة</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-4 rounded-2xl border border-orange-200">
                  ...
                  <h3 className="font-semibold text-orange-900 mb-1">إشعارات التطبيق</h3>
                ...
                <div className="space-y-4">
                  <div className="bg-white p-4 rounded-xl border border-gray-200 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900">تذكير موعد - د. صابر مكتافيش</h4>
                        <p className="text-sm text-gray-600">موعد غداً الساعة 9:00 صباحاً</p>
                        <p className="text-xs text-blue-600">سيتم الإرسال قبل 24 ساعة</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="bg-white p-4 rounded-xl border border-gray-200 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900">متابعة العلاج - فاطمة حسن</h4>
                        <p className="text-sm text-gray-600">تذكير بجلسة المتابعة الأسبوع القادم</p>
                        <p className="text-xs text-green-600">سيتم الإرسال يوم الأحد</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="bg-white p-4 rounded-xl border border-gray-200 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900">رسالة ترحيب - محمد خالد</h4>
                        <p className="text-sm text-gray-600">رسالة شكر وتعليمات ما بعد العلاج</p>
                        <p className="text-xs text-purple-600">تم الإرسال بنجاح</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                      <div>
                        <p className="font-medium text-gray-900">تذكيرات المواعيد</p>
                        <p className="text-sm text-gray-600">قبل 24 ساعة من الموعد</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                      <div>
                        <p className="font-medium text-gray-900">تذكيرات المتابعة</p>
                        <p className="text-sm text-gray-600">أسبوع بعد انتهاء العلاج</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                      <div>
                        <p className="font-medium text-gray-900">تذكيرات الأدوية</p>
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">نص التذكير</label>
                      <textarea
                        rows={3}
