    ...
    <div className="min-h-screen p-6 lg:mb-0 mb-16" dir="rtl">
      ...
      <div className="unified-product-grid product-scroll-enhanced lg:gap-6 mb-16">
        {filteredProducts.map((product) => (
          <div
            key={product.id}
            className="unified-product-card lg:w-auto bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 overflow-hidden group"
          >
            <div className="aspect-square bg-gray-50 relative overflow-hidden">
              <img
                src={product.image}
