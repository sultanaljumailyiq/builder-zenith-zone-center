...
const jobListings = [
  ...
  },
  {
    ...
    description:
      "نبحث عن طبيب أسنان أطفال متفهم للانضمام إلى عيادتنا الم��ص��ة للأطفال. مطلوب خبرة مع الأطفال القلقين والتقنيات الحديثة.",
    requirements: [
  ...
  },
  {
    ...
    description:
      "استشارات تقويم أسنا�� ثو��ية عن بُعد باستخدام تخطيط العلاج بالذكاء الاصطناعي. اعمل من أي مكان بينما تساعد المرضى في تحقيق ابتسامات مثالية.",
    requirements: [
  ...
  },
  {
    ...
    description:
      "عيادة حديثة في مدينة النجف تطلب طبيب أس��ان عام للانضمام لفريق عملها المتميز.",
