...
const Dashboard = () => {
  ...
  return (
    <div className={`space-y-6 ${isRTL ? "font-arabic" : ""}`} dir="rtl">
      {/* Clinic Selector */}
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        {/* Appointments Status */}
        <div className="col-span-12 lg:col-span-6 bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold text-gray-900">حالة المواعيد</h3>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    },
                    {
                      ...
                      message: "وصلت شحنة المواد الطبية الجديدة للمخزون",
                      time: "منذ ساعة",
                      urgent: false,
                    },
                    {
