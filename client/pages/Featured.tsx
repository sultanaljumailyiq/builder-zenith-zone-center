...
export default function Featured() {
  ...
  const ProductCard = ({ product }: { product: any }) => (
    <div className="group bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden relative bg-gradient-to-br from-white to-yellow-50">
      {/* Product Image */}
