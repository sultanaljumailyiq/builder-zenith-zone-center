        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  إدارة شاملة للعيادات والكادر الطبي
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-between">
              <div className="flex-1 max-w-md">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 rounded-2xl border border-gray-200 bg-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                  />
                </div>
              </div>
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg"
              >
            ...
            <div className="bg-white rounded-xl p-3 lg:p-6 border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg lg:text-2xl font-bold text-gray-900">
                    {clinics.reduce(
                      (acc, clinic) => acc + clinic.doctors.length,
                      0,
                    )}
                  </p>
                </div>
            ...
            <div className="bg-white rounded-xl p-3 lg:p-6 border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg lg:text-2xl font-bold text-gray-900">
                    {clinics.reduce(
                      (acc, clinic) => acc + clinic.totalAppointments,
                      0,
                    )}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg lg:text-2xl font-bold text-gray-900">
                    {(
                      clinics.reduce(
                        (acc, clinic) => acc + clinic.monthlyRevenue,
                        0,
                      ) / 1000000
                    ).toFixed(1)}
                    M د.ع
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
            {filteredClinics.map((clinic) => (
              <div
                key={clinic.id}
                className="bg-white rounded-2xl lg:rounded-3xl border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300"
              >
                  ...
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="flex items-center gap-1 lg:gap-2">
                      ...
                      <span
                        className={cn(
                          "text-xs font-medium",
                          clinic.isActive ? "text-green-600" : "text-red-600",
                        )}
                      >
                ...
                <div className="px-4 lg:px-6 py-3 lg:py-4 bg-gray-50">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-2 lg:px-3 py-1 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors ml-2"
                    >
                      {copiedUrl === clinic.bookingUrl ? (
                        <Check className="w-3 h-3 lg:w-4 lg:h-4 text-green-600" />
                      ) : (
                        <Copy className="w-3 h-3 lg:w-4 lg:h-4 text-gray-500" />
                      )}
                ...
                <div className="p-4 lg:p-6">
                  ...
                  <div className="flex gap-2 lg:flex-col lg:space-y-3 lg:gap-0 overflow-x-auto pb-2 lg:pb-0">
                    {clinic.doctors.slice(0, 3).map((doctor) => (
                      <div
                        key={doctor.id}
                        className="flex lg:flex-row items-center gap-2 lg:gap-3 p-2 lg:p-3 bg-gray-50 rounded-lg lg:rounded-xl min-w-[160px] lg:min-w-0"
                      >
                ...
                <div className="p-6 pt-0">
                  <div className="flex gap-2">
                    ...
                    <Link
                      to={`/clinic/${clinic.id}/dashboard`}
                      className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-green-50 text-green-600 rounded-xl hover:bg-green-100 transition-colors"
                    >
          ...
          {filteredClinics.length === 0 && (
            <div className="text-center py-12">
              ...
              <button
                onClick={() => setShowAddClinic(true)}
                className="flex items-center gap-2 px-6 py-3 bg-indigo-600 text-white rounded-2xl hover:bg-indigo-700 transition-colors mx-auto"
              >
                <Plus className="w-5 h-5" />
                إضافة عيادة جديدة
              </button>
